            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/admin/view-logo" class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/admin/view-products" class="menu-link">
                                    <div data-i18n="Without menu">View Post</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="/admin/add-products" class="menu-link">
                                    <div data-i18n="Without menu">Add Post</div>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/admin/view-category" class="menu-link">
                                    <div data-i18n="Without menu">View Post</div>
                                </a>
                            </li>
                            <li class="menu-item">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="/admin/view-news" class="menu-link">
                                    <div data-i18n="Without menu">View Post</div>
                                </a>
                            </li>
                            <li class="menu-item">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="{{ url('Images/' . auth()->User()->thumbnail) }}" alt
                                        ...
                                        <a class="dropdown-item" href="#">
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        <img src="{{ url('Images/' . auth()->user()->thumbnail) }}"
